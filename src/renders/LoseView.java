...
public class LoseView extends View {
    ...
    private JButton menuButton, restartButton, levelsButton;
    ...
    private void initializeConstraint() {
        ...
        buttonsConstraints= setConstraints(3, GridBagConstraints.SOUTH, buttonsInsets, GridBagConstraints.NONE, GridBagConstraints.NONE);
    } 
    ...
    public void initializeButtons(int width, int height) {
        ...
        restartButton = makeButton("RESTART",22);
        ...
        restartButton.addActionListener(e -> game.switchLevelView(LevelLoader.getSelectedLevel()));
    ...
    private void makeBackgroundLabel(int width, int height) {
        this.background= resizeImage(looseBackground, width, height);
    ...
    private void makeTopBar(int width, int height, int size) {
        ...
        topBar= makeText("level failed", size);
    }
    ...
    private void makeStarLabel(int width, int height) {
        ...
        starLabel.setBackground(new Color(78, 74, 78));
